...
export async function GET(req) {
  ...
  try {
    ...
    console.error("GET /api/comments error:", err, "tmdb_id:", tmdb_id);
...
export async function POST(req) {
  ...
  try {
    const { rows } = await sql`
      ...
      RETURNING id, user_id, ${user.username} as username, tmdb_id, content, parent_id, like_count, created_at, updated_at
    `;
